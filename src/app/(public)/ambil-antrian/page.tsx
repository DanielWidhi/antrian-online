...
import { ArrowLeft, Megaphone, Printer, CheckCircle2, Monitor, UserPlus, Loader2 } from "lucide-react";
...
export default function AmbilAntrianPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans print:hidden">
      ...
      {/* MOBILE HEADER */}
      <div data-aos="fade-down" className="md:hidden bg-blue-600 px-6 pt-10 pb-16 text-white rounded-b-[2.5rem] relative">
      ...
      <main className="flex-1 w-full max-w-lg mx-auto px-4 md:px-0 -mt-8 md:mt-10 z-10 flex flex-col pb-24 md:pb-10">
        <Card data-aos="zoom-in" className="shadow-lg border-none bg-white mb-6">
          <CardContent className="p-4 flex items-center justify-between">
            ...
            <div className="text-right">
              <span className="bg-emerald-100 text-emerald-700 text-[10px] px-2 py-1 rounded-full font-bold uppercase tracking-wider">Sistem Aktif</span>
              <p className="text-xs text-slate-500 font-medium mt-1">Menuju Loket 2</p>
            </div>
          </CardContent>
        </Card>

        <form data-aos="fade-up" onSubmit={handleSubmit} className="bg-white p-6 md:p-8 rounded-3xl shadow-xl border border-slate-100 flex flex-col gap-6">
      ...
      {/* MODAL PENDAFTARAN BERHASIL & TEMPLATE PRINT */}
      <Dialog open={showSuccessModal} onOpenChange={setShowSuccessModal}>
        {/* Tambahkan print:p-0 print:border-none print:shadow-none agar border popup hilang saat diprint */}
        <DialogContent className="sm:max-w-md rounded-3xl p-6 text-center print:p-0 print:border-none print:shadow-none print:bg-transparent">
          {/* ========================================================= */}
          {/* 🖨️ TEMPLATE CETAK STRUK KHUSUS (Hanya muncul di Kertas) */}
          {/* ========================================================= */}
          <div className="hidden print:block w-full max-w-[80mm] mx-auto text-black bg-white font-mono text-left">
            <div className="text-center mb-4">
              <h2 className="font-bold text-xl uppercase tracking-widest">LAYANAN ANTRIAN</h2>
              <p className="text-xs mt-1">Sistem Antrian Terpadu</p>
            </div>

            <div className="border-t-2 border-black border-dashed my-4"></div>

            <p className="text-center text-sm font-bold uppercase tracking-widest mb-1">Poli Anak</p>
            <h1 className="text-center text-7xl font-extrabold my-2">D-001</h1>
            <p className="text-center text-sm font-bold mb-4 uppercase">M Abdul Baqi</p>
            ...
            <div className="text-xs space-y-2">
              <div className="flex justify-between">
                <span>TANGGAL:</span>
                <span className="font-bold">14/06/2026</span>
              </div>
              <div className="flex justify-between">
                <span>JAM:</span>
                <span className="font-bold">11:12 WIB</span>
              </div>
              <div className="flex justify-between">
                <span>SISA TUNGGU:</span>
                <span className="font-bold">0 ORANG</span>
              </div>
            </div>

            <div className="border-t-2 border-black border-dashed mt-4 mb-2"></div>

            <p className="text-center text-[10px] mt-4">Silakan tunggu nomor Anda dipanggil oleh petugas.</p>
            <p className="text-center text-[10px] mt-1 font-bold">Terima Kasih</p>
          </div>
          {/* ========================================================= */}

          {/* 🌐 TAMPILAN MODAL NORMAL DI LAYAR (Sembunyi saat diprint) */}
          <div className="print:hidden flex flex-col items-center">
            <DialogHeader className="flex flex-col items-center w-full">
              ...
              <DialogDescription className="text-slate-500">Silakan simpan nomor antrian Anda</DialogDescription>
            </DialogHeader>

            <div className="bg-slate-50 border border-slate-200 p-6 rounded-2xl my-4 relative overflow-hidden w-full">
              ...
              <div className="border-t border-dashed border-slate-300 pt-4 text-xs text-slate-500 text-left space-y-2">
                <div className="flex justify-between">
                  <span>Tanggal:</span> <span className="font-medium text-slate-800">14/06/2026</span>
                </div>
                <div className="flex justify-between">
                  <span>Jam Daftar:</span> <span className="font-medium text-slate-800">11:12 WIB</span>
                </div>
                <div className="flex justify-between">
                  <span>Sisa Antrian:</span> <span className="font-bold text-blue-600">0 Orang lagi</span>
                </div>
              </div>
            </div>
